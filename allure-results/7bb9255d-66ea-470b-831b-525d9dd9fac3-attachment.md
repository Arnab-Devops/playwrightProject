...
- Name: loginPage.spec.ts >> verify valid login
- Location: tests\loginPage.spec.ts:7:5

# Error details

```
Error: locator.isVisible: InvalidSelectorError: Error while parsing selector `` - selector cannot be empty
    at parseAttributeSelector (<anonymous>:1899:11)
...
Call log:
    - checking visibility of internal:role= >> nth=0
        ...
        - generic [ref=e87]:
          ...
          - generic [ref=e91]:
            - generic [ref=e92]:
              ...
              - textbox "E-Mail Address" [ref=e94]: admin
            - generic [ref=e95]:
              - generic [ref=e96]: Password
              - textbox "Password" [ref=e97]: admin
